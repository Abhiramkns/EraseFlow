...
from utils.models.sd.pipeline_modified_sd import ModifiedStableDiffusionPipeline
from utils.models.flow.pipeline_modified_rf import ModifiedRectifiedFlowPipeline
...
def load_model(model_type="sdxl", target_ckpt=None, device="cuda", model_id_or_path=None, return_base_model=False, attack_type="i2p_nudity", target_ckpt_2=None, ddim=False):
    ...
    if target_ckpt is not None:
        ...
        elif "safetensors" and ( model_type == "sd3" or model_type == "flux" ) :
